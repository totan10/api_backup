...
class AdminEasyHealths extends Controller
{
    ...
    function add_dssec(Request $req)
    {
        ...
        $fields = [
            'DASH_SECTION_POSITION' => $input['DASH_SECTION_POSITION'],
            'DASH_SECTION_NAME' => $input['DASH_SECTION_NAME'],
            'DASH_SECTION_DESC' => $input['DASH_SECTION_DESC'],
            'DASH_TAGGED' => $input['DASH_TAGGED'],
            'DASH_SECTION_STATUS' => $input['DASH_SECTION_STATUS'],
        ];
        ...
        try {
            $dssecid = DB::table('dashboard_section')->insertGetId($fields);
            $response = [
                'Success' => True,
                'Message' => 'Records inserted successfully.',
                'PHOTO_URL' => $url ?? 'No file uploaded',
