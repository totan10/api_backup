...
Route::any('/vu_facilities', [AdminController::class,'vu_facilities']);
Route::any('/vu_facilities1', [AdminController::class,'vu_facilities1']);
Route::any('/add_facilities', [AdminController::class,'add_facilities']);
Route::any('/edit_facilities', [AdminController::class,'edit_facilities']);
Route::any('/vuupdt_facilities', [AdminController::class,'vuupdt_facilities']);
