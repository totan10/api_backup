...
//                 if ($dsid == 'TV') {
//                     $join->whereIn('hospital_facilities_details.DASH_SECTION_ID', ['SP', 'SR']);
//                 }
//             })
//             ->where(['facility_type.DT_STATUS' => 'Active', 'facility_section.DS_STATUS' => 'Active', 'facility.DN_STATUS' => 'Active'])
//             ->orWhere(function ($query) use ($dsid) {
//                 if ($dsid == 'TV') {
//                     $query->whereIn('hospital_facilities_details.DASH_SECTION_ID', ['SP', 'SR']);
//                 }
//             })
//             ->select(
//                 'facility_section.DASH_SECTION_ID',
