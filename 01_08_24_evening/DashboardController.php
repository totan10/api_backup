                        ...
                        function calculateAvailableDoctors($pid, $did)
                        {
                            ...
                            foreach ($totdr as $row1) {
                                    ...
                                    if (is_numeric($row->SCH_DAY)) {
                                        ...
                                        for ($i = 0; $i < 12; $i++) {
                                            ...
                                            if ($dates >= $cym) {
                                                ...
                                                $dr_status = ($row->ABS_TDT !== null && $row->ABS_TDT < $dates) ? "TIMELY" : ($row->CHK_IN_STATUS3 ?? $row->CHK_IN_STATUS2 ?? $row->CHK_IN_STATUS1 ?? $row->CHK_IN_STATUS);
                                ...
                                if (!empty($data) && $data[0]['SCH_DT'] === $cym) {
                                    ...
                                    if (!empty($sixRows) && $sixRows[0]['SCH_DT'] === $cym) {
                                        $c++;
                                    }
                                }
