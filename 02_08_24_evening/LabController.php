    ...
    private function getCatgDrDt($latt, $lont, $pid, $did)
    {
        ...
        foreach ($totdr as $row1) {
            ...
            if ($data[0]['SCH_DT'] === $cym) {
                ...
                // Check current time within FROM and TO slots
                ...
                $data[0]['FROM'] = $currentFromSlot ?? null;
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if (isset($input['PHARMA_ID'])) {
                    ...
                    foreach ($chkInTimes as $index => $chkin) {
                        ...
                        if ($data1->SLOT == '1') {
                            ...
                            while ($chkinTime->lessThan($chkoutTime)) {
                                ...
                                $slots[][] = $slotString;
                                if ($currentTime->between($chkinTime, $endSlot) && $slot_sts === 'Available') {
                                    $matchingSlot = $slotString;
                                    break 2; // Exit both loops
                                } elseif ($slot_sts === 'Available' && $nextAvailableSlot === null) {
                ...
                if (empty($result['Today_Doctors'])) {
                    ...
                    $filtered_ldr = $uniqueDoctors->sortBy(function ($doctor) {
                        $statusOrder = [
                            'IN' => 1,
                            'TIMELY' => 2,
                            'DELAY' => 3,
