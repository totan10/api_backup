...
use App\Http\Controllers\EasyHealths_Admin_Controller;
use App\Http\Controllers\EasyHealths_User_Controller;

//***** ADMIN CONTROLLER
Route::any('/admcliniclogin', [EasyHealths_Admin_Controller::class,'admcliniclogin']);
Route::post('/clientlogin', [EasyHealths_Admin_Controller::class, 'clientlogin']);
Route::any('/admindashboard', [EasyHealths_Admin_Controller::class,'admindashboard']);
Route::any('/allsrchtst', [EasyHealths_Admin_Controller::class,'allsrchtst']);
Route::any('/addtest', [EasyHealths_Admin_Controller::class,'addtest']);
Route::any('/testsrch', [EasyHealths_Admin_Controller::class,'testsrch']);
Route::any('/edittest', [EasyHealths_Admin_Controller::class,'edittest']);
Route::any('/edit_pkgtest', [EasyHealths_Admin_Controller::class,'edit_pkgtest']);
Route::any('/viewitem', [EasyHealths_Admin_Controller::class,'viewitem']);
Route::any('/addedtest', [EasyHealths_Admin_Controller::class,'addedtest']);
Route::any('/add_app_pkg', [EasyHealths_Admin_Controller::class,'add_app_pkg']);
Route::any('/add_pkgtest', [EasyHealths_Admin_Controller::class,'add_pkgtest']);
Route::any('/del_pkgtest', [EasyHealths_Admin_Controller::class,'del_pkgtest']);
Route::any('/vuclpkg', [EasyHealths_Admin_Controller::class,'vuclpkg']);
Route::any('/vupkgtest', [EasyHealths_Admin_Controller::class,'vupkgtest']);
Route::any('/pkgproftestsrch', [EasyHealths_Admin_Controller::class,'pkgproftestsrch']);
Route::any('/vuallpkgtest', [EasyHealths_Admin_Controller::class,'vuallpkgtest']);
Route::any('/pkg_dtls', [EasyHealths_Admin_Controller::class,'pkg_dtls']);
Route::any('/admtesthis', [EasyHealths_Admin_Controller::class,'admtesthis']);
Route::any('/preshis', [EasyHealths_Admin_Controller::class,'preshis']);
Route::any('/createstaff', [EasyHealths_Admin_Controller::class,'createstaff']);
Route::any('/viewstaff', [EasyHealths_Admin_Controller::class,'viewstaff']);
Route::any('/viewallstaff', [EasyHealths_Admin_Controller::class,'viewallstaff']);
Route::any('/userdashboard', [EasyHealths_Admin_Controller::class,'userdashboard']);
Route::any('/viewdoctors', [EasyHealths_Admin_Controller::class,'viewdoctors']);
Route::any('/allot', [EasyHealths_Admin_Controller::class,'allot']);
Route::any('/chkallot', [EasyHealths_Admin_Controller::class,'chkallot']);
Route::any('/vutestreq', [EasyHealths_Admin_Controller::class,'vutestreq']);
Route::any('/chating', [EasyHealths_Admin_Controller::class,'chating']);
Route::any('/vuchating', [EasyHealths_Admin_Controller::class,'vuchating']);
Route::any('/addsch', [EasyHealths_Admin_Controller::class,'addsch']);
Route::any('/admtodaydr', [EasyHealths_Admin_Controller::class,'admtodaydr']);
Route::any('/adddrcsv', [EasyHealths_Admin_Controller::class,'adddrcsv']);
Route::any('/vucatg', [EasyHealths_Admin_Controller::class,'vucatg']);
Route::any('/vunmc', [EasyHealths_Admin_Controller::class,'vunmc']);
Route::any('/adddr', [EasyHealths_Admin_Controller::class,'adddr']);
Route::any('/vudrprofile', [EasyHealths_Admin_Controller::class,'vudrprofile']);
Route::any('/drsts', [EasyHealths_Admin_Controller::class,'drsts']);
Route::any('/vuslot', [EasyHealths_Admin_Controller::class,'vuslot']);
Route::any('/vuslot1', [EasyHealths_Admin_Controller::class,'vuslot1']);
Route::any('/getsl', [EasyHealths_Admin_Controller::class,'getsl']);
Route::any('/drvisit', [EasyHealths_Admin_Controller::class,'drvisit']);
Route::any('/vunonsch', [EasyHealths_Admin_Controller::class,'vunonsch']);
Route::any('/editdr', [EasyHealths_Admin_Controller::class,'editdr']);
Route::any('/patientarrive', [EasyHealths_Admin_Controller::class,'patientarrive']);
Route::any('/hlthtrk', [EasyHealths_Admin_Controller::class,'hlthtrk']);
Route::any('/appntdr', [EasyHealths_Admin_Controller::class,'appntdr']);
Route::any('/tdpatient', [EasyHealths_Admin_Controller::class,'tdpatient']);
Route::any('/patientin', [EasyHealths_Admin_Controller::class,'patientin']);
Route::any('/clalldr', [EasyHealths_Admin_Controller::class,'clalldr']);
Route::any('/drleft', [EasyHealths_Admin_Controller::class,'drleft']);
Route::any('/editstaff', [EasyHealths_Admin_Controller::class,'editstaff']);
Route::any('/logout', [EasyHealths_Admin_Controller::class,'logout']);
Route::any('/editclinicprofile', [EasyHealths_Admin_Controller::class,'editclinicprofile']);
Route::any('/editsection', [EasyHealths_Admin_Controller::class,'editsection']);
Route::any('/addabout', [EasyHealths_Admin_Controller::class,'addabout']);
Route::any('/staffprivilege', [EasyHealths_Admin_Controller::class,'staffprivilege']);
Route::any('/staffleave', [EasyHealths_Admin_Controller::class,'staffleave']);
Route::any('/staffcl', [EasyHealths_Admin_Controller::class,'staffcl']);
Route::any('/vustaffcl', [EasyHealths_Admin_Controller::class,'vustaffcl']);
Route::any('/phopdadmin', [EasyHealths_Admin_Controller::class,'phopdadmin']);
Route::any('/admcatgclinicdr', [EasyHealths_Admin_Controller::class,'admcatgclinicdr']);
Route::any('/availdr', [EasyHealths_Admin_Controller::class,'availdr']);
Route::any('/viewappointment', [EasyHealths_Admin_Controller::class,'viewappointment']);
Route::any('/srchmob', [EasyHealths_Admin_Controller::class,'srchmob']);
Route::any('/admbooking', [EasyHealths_Admin_Controller::class,'admbooking']);
Route::any('/bookinginvoice', [EasyHealths_Admin_Controller::class,'bookinginvoice']);
Route::any('/cltestdash', [EasyHealths_Admin_Controller::class,'cltestdash']);
Route::any('/drdelay', [EasyHealths_Admin_Controller::class,'drdelay']);
Route::any('/drcancel', [EasyHealths_Admin_Controller::class,'drcancel']);
Route::any('/drleave', [EasyHealths_Admin_Controller::class,'drleave']);
Route::any('/testsearch_dummy', [EasyHealths_Admin_Controller::class,'testsearch_dummy']);
Route::any('/delsch', [EasyHealths_Admin_Controller::class,'delsch']);
Route::any('/editsch', [EasyHealths_Admin_Controller::class,'editsch']);
Route::any('/booktest_dummy', [EasyHealths_Admin_Controller::class,'booktest_dummy']);
Route::any('/testbookinghistory_dummy', [EasyHealths_Admin_Controller::class,'testbookinghistory_dummy']);
Route::any('/testinvoice_dummy', [EasyHealths_Admin_Controller::class,'testinvoice_dummy']);
Route::any('/vu_facility', [EasyHealths_Admin_Controller::class,'vu_facility']);
Route::any('/vu_pharma_facility', [EasyHealths_Admin_Controller::class,'vu_pharma_facility']);
Route::any('/vuupdt_facility', [EasyHealths_Admin_Controller::class,'vuupdt_facility']);
Route::any('/add_facility', [EasyHealths_Admin_Controller::class,'add_facility']);
Route::any('/vu_dept', [EasyHealths_Admin_Controller::class,'vu_dept']);
Route::any('/add_deptdr', [EasyHealths_Admin_Controller::class,'add_deptdr']);
Route::any('/drdashboard', [EasyHealths_Admin_Controller::class,'drdashboard']);
Route::any('/drappointments_dummy', [EasyHealths_Admin_Controller::class,'drappointments_dummy']);
Route::any('/drappnt_clinic_dummy', [EasyHealths_Admin_Controller::class,'drappnt_clinic_dummy']);
Route::any('/avail_chember', [EasyHealths_Admin_Controller::class,'avail_chember']);
Route::any('/vu_radiology', [EasyHealths_Admin_Controller::class,'vu_radiology']);
Route::any('/addtestsch', [EasyHealths_Admin_Controller::class,'addtestsch']);
Route::any('/vutestsch', [EasyHealths_Admin_Controller::class,'vutestsch']);
Route::any('/avail_testsch', [EasyHealths_Admin_Controller::class,'avail_testsch']);
Route::any('/vutestslot', [EasyHealths_Admin_Controller::class,'vutestslot']);
Route::any('/edittestsch', [EasyHealths_Admin_Controller::class,'edittestsch']);
Route::any('/deltestsch', [EasyHealths_Admin_Controller::class,'deltestsch']);
Route::any('/clinicalldr', [EasyHealths_Admin_Controller::class,'clinicalldr']);
Route::any('/edittest', [EasyHealths_Admin_Controller::class,'edittest']);
Route::any('/clinicsignup', [EasyHealths_Admin_Controller::class,'clinicsignup']);
Route::any('/drsignup', [EasyHealths_Admin_Controller::class,'drsignup']);
Route::any('/srchcity', [EasyHealths_Admin_Controller::class,'srchcity']);
Route::any('/pharmashortname', [EasyHealths_Admin_Controller::class,'pharmashortname']);
Route::post('/uploadgallery', [EasyHealths_Admin_Controller::class, 'uploadgallery']);
Route::post('/drsummary', [EasyHealths_Admin_Controller::class, 'drsummary']);
Route::post('/drdaysummary', [EasyHealths_Admin_Controller::class, 'drdaysummary']);
Route::post('/vu_superfacility', [EasyHealths_Admin_Controller::class, 'vu_superfacility']);
Route::post('/vu_pharma_superfacility', [EasyHealths_Admin_Controller::class, 'vu_pharma_superfacility']);
Route::post('/add_superspeciality', [EasyHealths_Admin_Controller::class, 'add_superspeciality']);



//*** USER CONTROLLER
Route::any('/apphome', [EasyHealths_User_Controller::class,'apphome']);
Route::any('/vucldoctrs', [EasyHealths_User_Controller::class,'vucldoctrs']);
Route::any('/phopd', [EasyHealths_User_Controller::class,'phopd']);
Route::any('/testfromhome', [EasyHealths_User_Controller::class,'testfromhome']);
Route::any('/pathologydata', [EasyHealths_User_Controller::class,'pathologydata']);
Route::any('/deptlist', [EasyHealths_User_Controller::class,'deptlist']);
Route::any('/dephosp_lst', [EasyHealths_User_Controller::class,'dephosp_lst']);
Route::any('/diagdephosp_lst', [EasyHealths_User_Controller::class,'diagdephosp_lst']);
...
Route::any('/diaghosp_lst', [LabController::class,'diaghosp_lst']);
...
Route::any('/booktest', [UserController::class,'booktest']);
...
// Route::any('/vu_radiology', [AdminController::class,'vu_radiology']);
// Route::any('/addtestsch', [AdminController::class,'addtestsch']);
// Route::any('/vutestsch', [AdminController::class,'vutestsch']);
// Route::any('/avail_testsch', [AdminController::class,'avail_testsch']);
// Route::any('/vutestslot', [AdminController::class,'vutestslot']);
// Route::any('/edittestsch', [AdminController::class,'edittestsch']);
// Route::any('/deltestsch', [AdminController::class,'deltestsch']);
...
Route::any('/admlogin', [AdminEasyHealths::class,'admlogin']);
...
Route::any('/add_symptom', [AdminEasyHealths::class,'add_symptom']);
Route::any('/updt_symptom', [AdminEasyHealths::class,'updt_symptom']);
...
Route::any('/add_facility_section', [AdminEasyHealths::class,'add_facility_section']);
Route::any('/updt_facility_section', [AdminEasyHealths::class,'updt_facility_section']);
Route::any('/updt_facility_section1', [AdminEasyHealths::class,'updt_facility_section1']);
...
Route::any('/updt_difaq', [AdminEasyHealths::class,'updt_difaq']);
Route::any('/updt_syfaq', [AdminEasyHealths::class,'updt_syfaq']);
Route::any('/updt_tdfaq', [AdminEasyHealths::class,'updt_tdfaq']);
Route::any('/updt_sdfaq', [AdminEasyHealths::class,'updt_sdfaq']);
Route::any('/updt_tfaq', [AdminEasyHealths::class,'updt_tfaq']);
Route::any('/updt_ditemfaq', [AdminEasyHealths::class,'updt_ditemfaq']);
Route::any('/updt_dsecfaq', [AdminEasyHealths::class,'updt_dsecfaq']);
Route::any('/add_dssec', [AdminEasyHealths::class,'add_dssec']);
Route::any('/updt_dssec', [AdminEasyHealths::class,'updt_dssec']);
Route::any('/updt_dssec1', [AdminEasyHealths::class,'updt_dssec1']);
Route::any('/add_dashitem', [AdminEasyHealths::class,'add_dashitem']);
Route::any('/updt_dashitem', [AdminEasyHealths::class,'updt_dashitem']);
Route::any('/updt_tstsubdept', [AdminEasyHealths::class,'updt_tstsubdept']);
Route::any('/updt_testdept', [AdminEasyHealths::class,'updt_testdept']);
