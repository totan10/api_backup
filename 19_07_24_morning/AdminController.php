...
class AdminController extends Controller
{
    ...
    // function edittestsch(Request $req)
    // {
    //     if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //         $input = $req->json()->all();
    //         $td = $input['EDIT_SCH'];
    ...
    //                 $response = ['Success' => true, 'Message' => 'Test schedule mofied successfully.', 'code' => 200];
    //             } catch (\Throwable $th) {
    //                 $response = ['Success' => false, 'Message' => $th->getMessage(), 'code' => 200];
    //             }
    //         }
    ...
    //     if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    //         $input = $req->json()->all();
    //         if (isset($input['PHARMA_ID']) && isset($input['DEPT_ID']) && isset($input['SUB_DEPT_ID'])) {

    //             $data = array();

    //             // if ($input['SUB_DEPT_ID'] == null) {
    //             //     $data = DB::table('test_schedule')->where(['PHARMA_ID' => $input['PHARMA_ID'], 'DEPT_ID' => $input['DEPT_ID']])->get();
    //             // } else {
    //                 $data = DB::table('test_schedule')->where(['PHARMA_ID' => $input['PHARMA_ID'], 'DEPT_ID' => $input['DEPT_ID'], 'SUB_DEPT_ID' => $input['SUB_DEPT_ID']])->get();
    //             // }
