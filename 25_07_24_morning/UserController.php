        ...
        if ($request->isMethod('post')) {
            ...
            if (isset($input['DIS_ID']) && isset($input['LATITUDE']) && isset($input['LONGITUDE'])) {
                ...
                if (is_numeric($input['SYM_ID'])) {
                    ...
                    $fxd_banner = DB::table('symptoms')
                    ->select('SYM_ID AS BANNER_ID', 'DIS_ID', 'SYM_NAME AS BANNER_NAME', 'DESCRIPTION', 
                             'SYMBNR1 AS BANNER_URL1', 'SYMBNR2 AS BANNER_URL2', 'SYMBNR3 AS BANNER_URL3', 
                             'SYMBNR4 AS BANNER_URL4', 'SYMBNR5 AS BANNER_URL5', 'SYMBNR6 AS BANNER_URL6', 
                             'SYMBNR7 AS BANNER_URL7', 'SYMBNR8 AS BANNER_URL8', 'SYMBNR9 AS BANNER_URL9', 
                             'SYMBNR10 AS BANNER_URL10', 'QA1', 'QA2', 'QA3', 'QA4', 'QA5')
