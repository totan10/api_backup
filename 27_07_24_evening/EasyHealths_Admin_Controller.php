...
class EasyHealths_Admin_Controller extends Controller
{
    ...
    // public function testsrch(Request $req)
    // {
    ...
    //         $addedTests = DB::table('clinic_testdata')
    //             ->where(['REMARK' => 'Added', 'PHARMA_ID' => $PID])
    //             ->select('TEST_ID', 'TEST_NAME', 'KNOWN_AS', 'REMARK')
    //             // ->select(
    //             //     'PHARMA_ID', 'HO_ID', 'TEST_ID', 'TEST_UC', 'TEST_SL', 'TEST_NAME',
    //             //     'TEST_TYPE', 'TEST_CODE', 'DEPT_ID', 'SUB_DEPT_ID', 'DEPARTMENT',
    //             //     'TEST_CATG', 'ORGAN_ID', 'ORGAN_NAME', 'ORGAN_URL', 'TEST_DESC',
    //             //     'KNOWN_AS', 'FASTING', 'GENDER_TYPE', 'AGE_TYPE', 'REPORT_TIME',
    //             //     'PRESCRIPTION', 'ID_PROOF', 'SAMPLE_ID', 'TEST_SAMPLE', 'NORMAL_RANGE',
    //             //     'QA1', 'QA2', 'QA3', 'QA4', 'QA5', 'QA6', 'COST', 'DISCOUNT',
    //             //     'HOME_COLLECT', 'SERV_CONDITION', 'STATUS', 'REMARK'
    //             // )
    //             ->get();
    //         $testIds = $addedTests->pluck('TEST_ID');
    ...
    //             isset($input['CITY']) && isset($input['PIN']) && isset($input['CLINIC_MOBILE'])
    //         ) {
    ...
    //                 'GST_NO' => $row['GST_NO'],
    //                 'TRADE_LIS_NO' => $row['TRADE_LIS_NO'],
    //                 'GST_DOC_URL' => $row['GST_DOC_URL'],
    //                 'TRADE_DOC_URL' => $row['TRADE_DOC_URL'],
    //                 'USERID' => $row['USERID'],
    //                 'PASSWORD' => $row['PASSWORD'],
    //                 'CHEMBER_CT' => $row['CHEMBER_CT'],
    //             ];
