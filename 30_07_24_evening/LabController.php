...
class LabController extends Controller
{
            ...
            if (isset($input['DASH_ID'], $input['LATITUDE'], $input['LONGITUDE'])) {
                ...
                try {
                    ...
                    * SIN(RADIANS('$latt'))))),2) as KM"),
                        ...
                        ->where(['hospital_facilities_details.DASH_ID'=> $f_id,'pharmacy.STATUS'=>'Active'])
                        ->get();
    ...
    function diaghosp_lst(Request $request)
    {
        if ($request->method() === 'POST') {
            ...
            if (isset($input['DASH_ID'], $input['LATITUDE'], $input['LONGITUDE'], $input['PHARMA_ID'])) {
                $f_id = $input['DASH_ID'];
                $latt = $input['LATITUDE'];
                $lont = $input['LONGITUDE'];
                ...
                try {
                    ...
                    * SIN(RADIANS('$latt'))))),2) as KM"),
                        ...
                        ->where(['hospital_facilities_details.DASH_ID'=> $f_id,'hospital_facilities_details.PHARMA_ID'=> $phid,'pharmacy.STATUS'=>'Active'])
                        ->get();
