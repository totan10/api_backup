    ...
    function addabout(Request $req)
    {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if (is_array($abt_arr) && !empty($abt_arr)) {
                    ...
                    foreach ($grouped_abt_arr as $section_id => $items) {
                        ...
                        if (in_array($count, [4, 6, 8])) {
                            ...
                            throw new Exception("DASH_SECTION_ID $section_id must have exactly 4, 6, or 8 items. Current count: $count");
                        }
                    }
                }
            ...
            if ($response['Success'] === false) {
                ...
                $response['Message'] .= " However, doctor availability was updated.";
            }
        } else {
            $response = ['Success' => false, 'Message' => 'Method Not Allowed.', 'code' => 405];
        }
