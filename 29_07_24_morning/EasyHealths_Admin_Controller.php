    ...
    public function clinicsignup(Request $req)
    {
        if ($req->isMethod('post')) {
            ...
            if (
                ...
                $brnch_cd = DB::table('pharmacy')->select('ID', 'PHARMA_ID')->where(['HO_ID' => $ho_id, 'STATE' => $row['STATE'], 'DIST' => $row['DIST'], 'CITY' => $row['CITY']])->orderBy('ID', 'desc')->first();
                if (!$brnch_cd) {
                    $brnch_value = '01';
                } else {
                ...
                if ($req->file('PHOTO_URL')) {
                    ...
                    $PHOTO_URL = asset('storage/clinicprofile/clinicphoto') . "/" . $PhotoL;
                } else {
                    $PHOTO_URL = null;
                }
                ...
                if ($req->file('PHOTO_URL1')) {
                    ...
                    $PHOTO_URL1 = asset('storage/clinicprofile/clinicphoto') . "/" . $PhotoP;
                } else {
                    $PHOTO_URL1 = null;
                }
                ...
                if ($req->file('LOGO_URL')) {
                    ...
                    $LOGO_URL = asset('storage/clinicprofile/cliniclogo') . "/" . $logo;
                } else {
                    $LOGO_URL = null;
                }
                ...
                if ($req->file('GST_DOC_URL')) {
                    ...
                    $GST_DOC_URL = asset('storage/clinicprofile/clinicdoc') . "/" . $gst;
                } else {
                    $GST_DOC_URL = null;
                }
                ...
                if ($req->file('TRADE_DOC_URL')) {
                    ...
                    $TRADE_DOC_URL = asset('storage/clinicprofile/clinicdoc') . "/" . $trd;
                } else {
                    $TRADE_DOC_URL = null;
                }
                ...
                $response = array("Success" => true, "Message" => 'Data inserted successfully', "code" => 200);
                } catch (\Throwable $th) {
